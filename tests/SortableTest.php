...
class SortableTest extends TestCase
{
    ...
    /** @test */
    public function it_can_move_before_a_model_to_earlier_model()
    {
        $firstModel = Dummy::find(3);
        $secondModel = Dummy::find(4);
        $thirdModel = Dummy::find(5);
        $fourthModel = Dummy::find(6);
        $fifthModel = Dummy::find(7);

        $this->assertEquals($firstModel->order_column, 3);
        $this->assertEquals($secondModel->order_column, 4);
        $this->assertEquals($thirdModel->order_column, 5);
        $this->assertEquals($fourthModel->order_column, 6);
        $this->assertEquals($fifthModel->order_column, 7);

        $fourthModel->moveBefore($secondModel);

        $this->assertEquals($firstModel->refresh()->order_column, 3);
        $this->assertEquals($fourthModel->refresh()->order_column, 4);
        $this->assertEquals($secondModel->refresh()->order_column, 5);
        $this->assertEquals($thirdModel->refresh()->order_column, 6);
        $this->assertEquals($fifthModel->refresh()->order_column, 8);
    }

    /** @test */
    public function it_can_move_before_a_model_to_latter_model()
    {
        $firstModel = Dummy::find(3);
        $secondModel = Dummy::find(4);
        $thirdModel = Dummy::find(5);
        ...
        $secondModel->moveBefore($fourthModel);

        $this->assertEquals($firstModel->refresh()->order_column, 3);
        $this->assertEquals($thirdModel->refresh()->order_column, 5);
        $this->assertEquals($secondModel->refresh()->order_column, 6);
        $this->assertEquals($fourthModel->refresh()->order_column, 7);
        $this->assertEquals($fifthModel->refresh()->order_column, 8);
    }

    /** @test */
    public function it_can_move_after_a_model_to_earlier_model()
    {
        $firstModel = Dummy::find(3);
        $secondModel = Dummy::find(4);
        $thirdModel = Dummy::find(5);
        ...
        $fourthModel->moveAfter($secondModel);

        $this->assertEquals($firstModel->refresh()->order_column, 3);
        $this->assertEquals($secondModel->refresh()->order_column, 4);
        $this->assertEquals($fourthModel->refresh()->order_column, 5);
        $this->assertEquals($thirdModel->refresh()->order_column, 6);
        $this->assertEquals($fifthModel->refresh()->order_column, 8);
    }

    /** @test */
    public function it_can_move_after_a_model_to_latter_model()
    {
        $firstModel = Dummy::find(3);
        $secondModel = Dummy::find(4);
        $thirdModel = Dummy::find(5);
        ...
        $secondModel->moveAfter($fourthModel);

        $this->assertEquals($firstModel->refresh()->order_column, 3);
        $this->assertEquals($thirdModel->refresh()->order_column, 5);
        $this->assertEquals($fourthModel->refresh()->order_column, 6);
        $this->assertEquals($secondModel->refresh()->order_column, 7);
        $this->assertEquals($fifthModel->refresh()->order_column, 8);
    }
